...
Pystern Blot can hand over the original image at three different levels, from raw instrument
output to the finished figure:
...
Exporting the source file or the annotated context TIFF satisfies the raw image submission requirements of Springer Nature, EMBO Press, eLife, and PLOS.
